...
class TurnoIntegracionTests {
	...
	public void registrarTurno() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.post("/pacientes/save")
				.contentType(MediaType.APPLICATION_JSON)
				.content(asJsonString(paciente)))
				.andDo(MockMvcResultHandlers.print())
				.andExpect(MockMvcResultMatchers.status().isOk()).andReturn();

		this.mockMvc.perform(MockMvcRequestBuilders.post("/odontologos/save")
				.contentType(MediaType.APPLICATION_JSON)
				.content(asJsonString(od)))
				.andDo(MockMvcResultHandlers.print())
				.andExpect(MockMvcResultMatchers.status().isOk()).andReturn();

		MvcResult response = this.mockMvc.perform(MockMvcRequestBuilders.post("/turnos/save")
				.contentType(MediaType.APPLICATION_JSON)
